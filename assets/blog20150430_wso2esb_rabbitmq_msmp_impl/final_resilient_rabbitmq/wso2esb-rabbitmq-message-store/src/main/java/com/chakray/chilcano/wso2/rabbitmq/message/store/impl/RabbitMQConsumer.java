...
public class RabbitMQConsumer implements MessageConsumer {
    ...
    //public RabbitMQConsumer(JmsStore store) {
    ...
    public RabbitMQConsumer setSession(Session session) {
    ...
    public RabbitMQConsumer setConsumer(javax.jms.MessageConsumer consumer) {
