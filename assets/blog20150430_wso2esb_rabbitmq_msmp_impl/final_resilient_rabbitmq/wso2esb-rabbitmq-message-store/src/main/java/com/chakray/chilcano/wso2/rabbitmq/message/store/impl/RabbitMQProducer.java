...
package com.chakray.chilcano.wso2.rabbitmq.message.store.impl;
...
public class RabbitMQProducer implements MessageProducer {
    ...
    //public RabbitMQProducer(JmsStore store) {
    ...
    public RabbitMQProducer setConnection(Connection connection) {
        this.connection = connection;
        return this;
    }

    public RabbitMQProducer setSession(Session session) {
        this.session = session;
        return this;
    }

    public RabbitMQProducer setProducer(javax.jms.MessageProducer producer) {
