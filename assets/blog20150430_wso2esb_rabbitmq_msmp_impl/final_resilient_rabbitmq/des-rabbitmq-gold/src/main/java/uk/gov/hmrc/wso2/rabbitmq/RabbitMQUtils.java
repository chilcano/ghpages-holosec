...
/**
 * 
 * <b>This class has been extended (cloned) from org.apache.axis2.transport.rabbitmq.utils.RabbitMQUtils<b>
 * 
 * Class that performs operations as createConnection, getSOAPActionHeader, etc.
 */
public class RabbitMQUtils {
    ...
    public static Connection createConnection(ConnectionFactory factory) throws IOException {
        ...
        boolean automaticRecovery = true;
        boolean topologyRecovery = false;
        ...
        try {
        	...
        	else log.error("---> createConnection() error reading uk.gov.hmrc.wso2.uct.RABBIT_CONSUMMER_TIMEOUT. Setting default NetworkRecoveryInterval to 60 seconds");
        } catch (NumberFormatException e) {
        	log.error("---> createConnection() error reading uk.gov.hmrc.wso2.uct.RABBIT_CONSUMMER_TIMEOUT. Setting default NetworkRecoveryInterval to 60 seconds");
        }

        long networkRecoveryInterval = seconds*1000;
        
        log.debug("createConnection() ~ connection was created with AutomaticRecovery = true and NetworkRecoveryInterval = " + seconds + " secs." );
        ...
        log.debug("createConnection() ~ setTopologyRecoveryEnabled = false ");
