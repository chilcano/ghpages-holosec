...
public class RabbitMQEndpoint extends ProtocolEndpoint {
    ...
    public void ExtendedServiceTaskManager(ServiceTaskManager serviceTaskManager) {
    ...
    public boolean loadConfiguration(ParameterInclude params) throws AxisFault {
        ...
        serviceTaskManager = ServiceTaskManagerFactory.createTaskManagerForService(connectionFactory, service, workerPool);
        serviceTaskManager.setRabbitMQMessageReceiver(new RabbitMQMessageReceiver(rabbitMQListener, connectionFactory, this));
