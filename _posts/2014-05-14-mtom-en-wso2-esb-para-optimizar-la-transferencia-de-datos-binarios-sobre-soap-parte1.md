...
![wso2esb-soapui-mtom](/assets/blog20140430_wso2_mtom/wso2esb-soapui-mtom.png){:width="40%"}
...
![MTOMSwASampleService operaciones](/assets/blog20140430_wso2_mtom/wso2-esb-mtom-MTOMSwASampleService-soapui-01.png){:width="70%"}  
_MTOMSwASampleService operaciones_
...
![Haciendo MTOM SOAP request a uploadFileUsingMTOM](/assets/blog20140430_wso2_mtom/wso2-esb-mtom-MTOMSwASampleService-soapui-02-uploadFileUsingMTOM.png){:width="90%"}   
_Haciendo MTOM SOAP request a uploadFileUsingMTOM_
...
![Proyecto SoapUI: Proxy MTOMSwASampleService](/assets/blog20140430_wso2_mtom/wso2-esb-mtom-MTOMSwASampleService-soapui-03-proxy.png){:width="50%"}  
_Proyecto SoapUI: Proxy MTOMSwASampleService_
...
Pues los proxies de WSO2 ESB nuevos y actualizados, el Form HTML, el servicio `MTOMSwASampleService` modificado [los publicaré en un segundo post en este blog](/2014/05/14/mtom-en-wso2-e…re-soap-parte1). 
...
* [WSO2 ESB: Sample 51: MTOM and SwA Optimizations and Request/Response Correlation](https://docs.wso2.org/pages/viewpage.action?pageId=33136025)
* [SoapUI: Adding Headers and Attachments](http://www.soapui.org/SOAP-and-WSDL/adding-headers-and-attachments.html)
