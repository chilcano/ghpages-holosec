...
/**
 * 
 * <b>This class has been extended (cloned) from org.apache.axis2.transport.rabbitmq.RabbitMQSender<b>
 * 
 * The TransportSender for RabbitMQ AMQP Transport
 */
public class RabbitMQSender extends org.apache.axis2.transport.rabbitmq.RabbitMQSender {
    ...
    private void sendOverAMQP(MessageContext msgContext, RabbitMQMessageSender sender) throws AxisFault {
    	log.debug(" ===> sendOverAMQP() - start");
        try {
